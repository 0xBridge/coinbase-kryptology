...
```$xslt
go get github.com/0xBridge/coinbase-kryptology
```

Pin a specific release of this library:
```$xslt
go get github.com/0xBridge/coinbase-kryptology@v1.6.0
```

## Documentation

Public documentations can be found at https://pkg.go.dev/github.com/0xBridge/coinbase-kryptology

To access the documentation of the local version, run `godoc -http=:6060` and open
the following url in your browser.

http://localhost:6060/pkg/github.com/0xBridge/coinbase-kryptology/

## Developer Setup
**Prerequisites**: `golang 1.17`, `make`

```$xslt
git clone git@github.com/0xBridge/coinbase-kryptology.git && make 
``` 
